...
type CoursePartClientProps = {
  part: {
    ...
    duration: string
    outcomes: string[]
    lessons: { id: string; title: string; blocks: any[] }[]
    checkpoint: { title: string; blocks: any[] }
    quiz: any[]
  }
  slug: string
}

export function CoursePartClient({ part, slug }: CoursePartClientProps) {
