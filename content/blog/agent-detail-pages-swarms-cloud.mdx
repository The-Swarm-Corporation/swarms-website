...
![An agent's page on Swarms Cloud: activity, system prompt, and the full configuration table](/agent_config_page_swarms_cloud.png)
...
![Run history for an agent, with the per-run context window fill grid open](/context_window_usage_swarms_cloud.png)
