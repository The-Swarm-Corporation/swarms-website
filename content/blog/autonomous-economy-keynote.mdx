...
Create a key in the [Swarms Platform dashboard](https://swarms.world/platform/api-keys) and export it as an environment variable:
...
[Read the full keynote presentation](https://docs.google.com/presentation/d/1ssjQUMRaUbmGAjkwsmVwWLxfjo9Kl46VyJbTpo25Xng/edit?usp=sharing), get an API key at [swarms.world](https://swarms.world/platform/api-keys), and start building at [docs.swarms.ai](https://docs.swarms.ai).
