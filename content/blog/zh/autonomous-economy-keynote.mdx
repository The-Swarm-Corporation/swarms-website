...
在 [Swarms 平台控制台](https://cloud.swarms.world/api-keys)创建密钥，并导出为环境变量：
...
[阅读完整主题演讲](https://docs.google.com/presentation/d/1ssjQUMRaUbmGAjkwsmVwWLxfjo9Kl46VyJbTpo25Xng/edit?usp=sharing)，在 [swarms.world](https://cloud.swarms.world/api-keys) 获取 API 密钥，并前往 [docs.swarms.ai](https://docs.swarms.ai) 开始构建。
