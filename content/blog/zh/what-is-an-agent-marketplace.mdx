...
**安装与认证。** 安装框架，并在 [swarms.world/platform/api-keys](https://cloud.swarms.world/api-keys) 获取 API 密钥：
...
理解智能体市场最快的方式就是亲自逛一逛。在 [swarms.world](https://swarms.world) 探索智能体、提示词和工具，用[免费 API 密钥](https://cloud.swarms.world/api-keys)发布你的第一个组件，并在 [docs.swarms.ai](https://docs.swarms.ai) 阅读完整的市场文档。如果你正在构建智能体经济所依赖的组件，市场就是它们找到买家的地方。
