  ...
  mainEntity: {
    ...
    itemListElement: [
      ...
      },
      {
        "@type": "WebPage",
        position: 2,
        name: "Swarms Marketplace Course (Coming Soon)",
        url: "https://swarms.world",
        description:
          "A dedicated course on publishing, pricing, and selling AI agents and prompts is coming soon.",
      },
      {
        "@type": "WebPage",
        position: 3,
        name: "Swarms Framework Course (Coming Soon)",
        url: "https://docs.swarms.world",
        description:
          "A dedicated course on the production-grade Python multi-agent framework is coming soon.",
      },
      {
        "@type": "WebPage",
        position: 4,
